          ...
          <ul className="flex items-center space-x-10 text-[#4f4f4f] uppercase tracking-wide text-sm lg:text-base xl:text-lg">
            {navItems.map((item) => (
              <li key={item.label}>
                <Link
                  href={item.href}
                  className={`transition text-poppins-md cursor-pointer ${
                    pathname === item.href
          ...
          <>
            ...
            >
              <div className="flex flex-col items-center justify-center h-full text-center px-6">
                <ul className="flex flex-col items-center space-y-6 text-[#4f4f4f] uppercase tracking-wide text-base">
                ...
                <motion.button
                  ...
                  className="mt-10 w-full text-white bg-[#09B8DC] rounded-full px-6 py-2.5 hover:bg-[#08A0C6] transition duration-300 text-lg cursor-pointer"
                >
                  Schedule Meet
                </motion.button>
              </div>
