...
import { Eye, Calendar, ExternalLink, MapPin, X } from "lucide-react";
                ...
                <div className="p-4 w-full">
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 justify-between items-center text-gray-600 mb-4 pb-4 border-b">
                    ...
                    <div className="flex items-center gap-4 text-sm whitespace-nowrap">
                      <span>By <Link href={`/users/${name || ''}`} className="font-semibold text-blue-600 hover:underline">{name || 'Unknown'}</Link></span>
                    </div>
                  </div>
                  <div
