...
//   return (
//     <div className="w-[90%] mx-auto p-6 bg-gray-50 mb-80">
//       {/* Bento Grid */}
//       <div className="bg-white rounded-b-lg p-4">
//         <div className="grid grid-cols-7 gap-3 h-96">
//           {/* google tag */}
//           <div className="col-span-7">
//             <div className="inline-block bg-[#23262B] text-white px-6 py-8 gap-10 rounded-2xl shadow w-full">
...
//           {/* Top Row */}
//           <div className="col-span-2 bg-[#23262B] text-white p-4 rounded-lg flex flex-col justify-center items-center text-center gap-1">
...
//               />
//             </div>
//             <h4 className="text-sm font-semibold mb-1">TechTrendsHub</h4>
//             <StarRating />
...
//           <div className="col-span-2 bg-[#23262B] text-white p-4 rounded-lg flex flex-col justify-center items-center text-center gap-1">
//             <div className="w-10 h-10 rounded-full bg-gray-600 mb-3 overflow-hidden">
//               <img
...
//           <div className="col-span-3 bg-[#23262B] text-white p-4 rounded-lg flex flex-col text-center justify-center items-center  ">
//             <div className="w-10 h-10 rounded-full bg-gray-600 mb-3 overflow-hidden">
//               <img
//                 src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face"
//                 alt="TechTrendsHub"
...
//           {/* Bottom Row */}
//           <div className="col-span-5 bg-[#23262B] text-white p-4 rounded-lg flex flex-col text-center justify-center items-center gap-1 py-12">
//             <div className="w-10 h-10 rounded-full bg-gray-600 mb-3 overflow-hidden">
//               <img
//                 src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face"
//                 alt="TechTrendsHub"
...
//           <div className="col-span-2 bg-[#23262B] text-white p-4 rounded-lg flex flex-col text-center justify-center items-center gap-1">
//             <div className="w-10 h-10 rounded-full bg-gray-600 mb-3 overflow-hidden">
//               <img
//                 src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face"
//                 alt="TechTrendsHub"
