...
import StaffBlogEdit from "./routers/staff/StaffBlogEdit"; // Import staff blog edit page
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route element={<AdminLayout />}>
              ...
              <Route path="/staff/blog/edit/:id" element={<StaffProtectedRoute><StaffBlogEdit /></StaffProtectedRoute>} />
            </Route>
          </Routes>
        </Router>
      </AuthProvider>
