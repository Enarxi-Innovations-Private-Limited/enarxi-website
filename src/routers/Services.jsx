...
//   <article
//     className={`grid items-center bg-white rounded-2xl shadow p-6 md:p-10 gap-6
...
//       <h3 className="text-xl md:text-2xl font-bold text-project_text_color_primary">
...
//         <button
//           type="button"
//           className="px-5 py-2.5 border border-blue-500 text-blue-600 rounded-full hover:bg-blue-50 transition"
...
//         <button
//           type="button"
//           className="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-full hover:bg-gray-100 transition"
...
//   return (
//     <section className="bg-[#F5FBFF] py-12 md:py-16">
//       <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
//         <header className="text-center mb-10 md:mb-14">
//           <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 font-oswald">
...
//           {SERVICES.map((s, i) => (
//             <ServiceCard key={s.id} service={s} reverse={i % 2 !== 0} />
//           ))}
//         </div>
...
//               </p>
//               <ul className="list-disc ml-6 space-y-2 text-project_text_color_primary font-poppins">
//                 <li>
//                   Proven track record delivering diverse electronic products.
//                 </li>
//                 <li>Proficient in circuit design and validation.</li>
//                 <li>Expertise in embedded systems and advanced devices.</li>
//                 <li>
...
//                 alt="Person working with electronics"
//                 className="w-full max-w-[420px] h-auto object-contain mt-4"
//                 loading="lazy"
//               />
//             </div>
