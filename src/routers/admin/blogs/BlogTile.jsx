...
import { FileText, Calendar, User, Eye, CheckCircle, Trash2, Image as ImageIcon } from 'lucide-react';

const BlogTile = ({ blog, onView, onApprove, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 bg-gradient-to-br from-blue-50 to-gray-100 overflow-hidden">
        ...
        {/* View Badge */}
        <div className="absolute top-2 left-2 bg-blue-600 bg-opacity-90 text-white px-2 py-1 rounded-md text-xs font-medium flex items-center space-x-1">
