          ...
          <div className="grid gap-6 grid-cols-2 lg:grid-cols-3">
            {features.map((feat) => (
              <div
                ...
                transition-transform duration-300 hover:scale-105 justify-center items-center relative"
              >
                {/* Animate the icon and add wind effect for "Faster build time" */}
                <div className="relative">
                  ...
                  {feat.title === "Faster build time" && (
                    <div className="absolute -top-2 -right-8 w-16 h-4 bg-blue-200 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      <div className="w-full h-full bg-[linear-gradient(to_right,transparent,white,transparent)] animate-wind"></div>
                    </div>
                  )}
                </div>
