...
//   const horizontalScrollWrapper = useRef(null); // New ref for the scroll wrapper
...
//         // The height of the wrapper is the scroll distance + viewport height
//         horizontalScrollWrapper.current.style.height = `${
//           scrollDistance + window.innerHeight
//         }px`;

//         gsap.to(horizontalSections, {
//           x: () => -(scrollWidth - viewportWidth), // Animate the X position based on content width
//           ease: "none",
//           scrollTrigger: {
...
//       {/* Mobile Horizontal Scroll */}
//       <div
//         ref={horizontalScrollWrapper} // This is the new wrapper for the vertical scroll space
//         className="block h-[400vh] md:hidden" // Set a large height to create vertical scroll
//       >
//         <div
//           ref={horizontalRef}
//           className="sticky top-0 flex flex-row w-[500vw] h-screen overflow-x-hidden"
//         >
