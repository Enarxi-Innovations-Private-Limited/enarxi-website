...
const HeroComponent = () => {
  return (
    <section className="w-full min-h-[98vh] bg-gradient-to-b from-[#DEF4FF] to-white flex flex-col items-center justify-between text-center px-4 py-8">
      
      {/* Text content */}
      <div className="space-y-4 max-w-4xl pt-80 sm:pt-50  md:pt-40 lg:pt-20   ">
      ...
      {/* Video container */}
      <div className="w-full max-w-[80%] md:max-w-[60%] lg:max-w-[40%]">
        <video
          src={heroVideo}
          autoPlay
          loop
